...
function PublicLayout() {
  return (
    <div className="flex min-h-screen flex-col">
      {/* Keyboard a11y: lets users jump past the nav straight to the content. */}
      <a
        href="#main"
        className="sr-only focus:not-sr-only focus:absolute focus:right-4 focus:top-4 focus:z-50 focus:rounded-lg focus:bg-brand-700 focus:px-4 focus:py-2 focus:text-sm focus:font-medium focus:text-white"
      >
        דלג לתוכן
      </a>
      <Navbar />
